...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_00_quickstart.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_00_quickstart.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 15-183
...
.. _sphx_glr_download_examples_00_quickstart.py:
